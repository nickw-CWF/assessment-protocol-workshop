...
<h3>
Workshop: Developing National Protocols for Assessing Aquatic Barriers in Canada
</h3>
...
Increased focus on freshwater connectivity and fish passage:
...
# Why develop national protocols for assessing aquatic barriers in Canada?
...
2. Field assessment protocols for passability
...
1. National database
2. National barrier assessment protocols

&nbsp;

<center>
![database](./img/database.png){height=200px} ![protocol](./img/protocol.png){height=200px}
</center>

## National assessment protocols

- Several barrier assessment protocols have been developed for different regions in Canada
- Avoid independent development of protocols region by region
- Gaps/limited application of protocols for:
  + Low-head dams
  + Waterfalls
  + Lateral barriers
  + Specialized structures (e.g., tide gates/aboiteaux)
- CABD requires consistent data structures
...
An important question we were asked: **<span style="color: #de3c26;">What is the purpose of assessing crossings?</span>**
...
For this workshop: Development of field protocols to assess stream crossings for **<span style="color: #de3c26;">passability</span>**

## Additional considerations

1. Scoring systems - what is a barrier to aquatic species?
...
- Central repository requires a common set of fields
- Inform decision making, facilitate data management and sharing
- Field assessment methods &rarr; data structures
...
#. Provide a set of stream crossing assessment protocols for parts of Canada that do no have them
#. Inform the data structure for stream crossings in CABD

## Desired Outcomes

In future years, develop assessment protocols for additional barrier types (e.g., tide gates/aboiteaux, waterfalls, lateral structures)
